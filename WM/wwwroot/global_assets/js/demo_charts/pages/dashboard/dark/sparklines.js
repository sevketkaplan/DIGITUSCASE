...
var DashboardSparklines = function() {
    ...
    return {
        init: function() {
            ...
            _chartSparkline('#server-load', 'area', 30, 80, 'basis', 750, 2000, 'rgba(255,255,255,0.5)');
            _chartSparkline('#server-load_2', 'area', 30, 80, 'basis', 755, 2000, 'rgba(255,255,255,0.5)');
            _chartSparkline('#server-load_3', 'area', 30,80 'basis', 750, 2000, 'rgba(255,255,255,0.5)');
